...
<head>
    ...
    <script type="text/javascript" src="/sipcms/panel/js/jquery.pjax.js"></script>
    <script type="text/javascript" src="/sipcms/panel/js/pjax.js"></script>
...
<body>
	...
	<div id="wrapper" class="pngf">
        ...
        <!--  end INFOPANEL  -->
            ...
            <div class="toolPanel pngf">
                <a class="close"></a><a class="set"></a>
                    <ul class="button pngf">
                        ...
                        <li>
	                    <a href="/panel/news" class="hoverable pjax">
            ...
            <!--  end ToolPanel  -->
            <?php
            }elseif(Request::initial()->controller() == 'news')
            {
            ?>
            <!--  ToolPanel  -->
